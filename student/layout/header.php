...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="menu-item">
            <a href="./student_dashboard.php" style="text-decoration: none; color:#ffff"><span><i class="fa-solid fa-house-chimney"></i> <span class="text">Dashboard</span></span> </a>
        </div>      
        <!-- teacher menu -->
    ...
    <div class="main">
        ...
        <div class="admin-menu">
            ...
            <button id="adminBtn" class="admin-button"><i class="fa-solid fa-user-tie me-2"></i>Student</button>
